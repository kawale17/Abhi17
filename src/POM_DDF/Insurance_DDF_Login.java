...
public class Insurance_DDF_Login {
...
//POM-I
	...
	private WebElement Email;// Private WebElement
								// Email=driver.findElement(By.xpath("//input[@id='email']"));

	@FindBy(xpath = "//input[@id='password']")
	private WebElement Password; // Private WebElement
	...
	public Insurance_DDF_Login(WebDriver driver) 
	{
